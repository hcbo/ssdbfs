...
public class MfsFileSystem extends FileSystem {
    ...
    RfsUnderFileSystem rfsUnderFileSystem;
    ...
    public void initialize(URI uri, Configuration conf) throws IOException { // get
        ...
        this.uri = uri;
        rfsUnderFileSystem = new RfsUnderFileSystem(uri, conf);
    }
    ...
    public FSDataInputStream open(Path path, int bufferSize) throws IOException {
        ...
        try {
            InputStream inputStream = rfsUnderFileSystem.open(path.toString());
            return new FSDataInputStream(inputStream);
        } catch (Exception ex) {
//            LOG.error("open path: {} bufferSize:{}", path, bufferSize, ex);
...
//        OutputStream outputStream = neuUnderFileSystem.create(path.toString());
        OutputStream outputStream = rfsUnderFileSystem.create(path.toString());
...
//        }
    ...
    public boolean rename(Path src, Path dst) {
        ...
        return rfsUnderFileSystem.renameFile(src.toString(),dst.toString());
...
//        seaweedFileSystemStore.rename(qualifiedSrcPath, qualifiedDstPath);
    ...
    public FileStatus[] listStatus(Path path) throws FileNotFoundException, IOException {
        ...
        return  rfsUnderFileSystem.listStatus(path.toString());
    }
...
//        }
        ...
        return rfsUnderFileSystem.mkdirs(path.toString());
    }
    ...
    public FileStatus getFileStatus(Path path) throws FileNotFoundException,
        ...
        return rfsUnderFileSystem.getFileStatus(path.toString());
    }
